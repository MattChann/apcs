...
public class OrderedList_inArraySlots
    ...
    public OrderedList_inArraySlots(ArrayList<Integer> unordered) {
        ...
        for(int i=0; i<list_iAS.size(); i++) {
            int indexOfSmallest = champIndex(list_iAS, i);
            Integer smallestElement = list_iAS.get(indexOfSmallest);

            list_iAS.set(indexOfSmallest, list_iAS.get(i));
            list_iAS.set(i, smallestElement);
        }
    }
    ...
    /** 
      ...
      @return the index of the smallest element in list starting from startingIndex
     */
    private int champIndex(ArrayList<Integer> list, int startingIndex) {
        int indexOfSmallest = startingIndex;
        Integer smallestElement = list.get(startingIndex);
